const copy = {
  ru: {
    ...
    homeTitle: "Свадебные платья и пошив в одном месте",
    homeIntro: "Примерь готовое платье, закажи индивидуальный пошив или подгони уже выбранное.",
    ...
    lookTitle: "Посмотри подборку платьев",
    lookText: "Ассортимент меняется. Наличие конкретного платья уточним до визита.",
    ...
    dressesLead: "Примерь разные силуэты, ткани и детали. Наличие конкретного платья уточним до визита.",
    dressesCaption: "CATRIN · свадебные платья",
    lookbookEyebrow: "Посмотри до визита",
    lookbookTitle: "Силуэты и детали",
    lookbookIntro: "Фотографии помогут выбрать направление. Окончательный выбор лучше сделать на примерке.",
  ...
  en: {
    ...
    homeTitle: "Wedding dresses and dressmaking in one place",
    homeIntro: "Try a ready-made gown, order a bespoke dress or alter one you have already chosen.",
    ...
    lookTitle: "Explore the dress selection",
    lookText: "The selection changes. We will confirm a particular gown before your visit.",
    ...
    dressesLead: "Try different silhouettes, fabrics and details. We will confirm a particular gown before your visit.",
    dressesCaption: "CATRIN · wedding dresses",
    lookbookEyebrow: "Explore before visiting",
    lookbookTitle: "Silhouettes and details",
    lookbookIntro: "Photographs help choose a direction. The final choice is best made during a fitting.",
