const copy = {
  ru: {
    ...
    homeEyebrow: "Свадебный салон и мастерская в Елгаве · с 2011 года",
    homeTitle: "Свадебное платье, которое станет именно твоим",
    ...
    homeStoryTitle: "Салон и мастерская работают как одна команда",
    homeStoryText: "Здесь платье можно не только найти, но и сшить, подогнать и подготовить до последней детали. Начинаем с разговора и решаем именно твою задачу.",
    ...
    salonTitle: "Свадебный салон и мастерская CATRIN",
    salonLead: "С 2011 года помогаем выбирать, шить и подгонять свадебные платья. Салон находится в Елгаве.",
  ...
  en: {
    ...
    homeEyebrow: "Bridal salon and studio in Jelgava · since 2011",
    homeTitle: "A wedding dress that feels entirely yours",
    ...
    homeStoryTitle: "The salon and studio work as one team",
    homeStoryText: "Here a dress can be found, made, altered and prepared down to the final detail. We begin with a conversation and focus on what you need.",
    ...
    salonTitle: "CATRIN bridal salon and sewing studio",
    salonLead: "Since 2011, we have helped clients choose, make and alter wedding dresses. The salon is in Jelgava.",
...
const metadata = {
  ru: {
    home: ["CATRIN — Свадебные платья и швейная мастерская", "Свадебные платья, индивидуальный пошив, подгонка, ремонт и химчистка в салоне CATRIN."],
  ...
  en: {
    home: ["CATRIN — Wedding dresses and sewing studio", "Wedding dresses, bespoke dressmaking, alterations, repairs and dry cleaning at CATRIN."],
