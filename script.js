...
const translations = {
  lv: {
    ...
    heroLead: "Kāzu kleitas pārdošanai un nomai, aksesuāri un personiska piemeklēšana — vienā mierīgā, privātā pielaikošanā Jelgavas centrā.",
    ...
    servicesKicker: "Viss vienuviet",
    servicesTitle: "Ne tikai izvēlēties.<br><em>Arī sagatavot līdz galam.</em>",
    servicesLead: "No pirmās pielaikošanas līdz kleitai, kas ir gatava tavai dienai. Par konkrēta modeļa, izmēra vai pakalpojuma pieejamību pajautā mums WhatsApp.",
    servicePrimaryLabel: "Galvenais",
    serviceDressTitle: "Kāzu kleitas",
    serviceDressText: "Modeļi dažādiem siluetiem, gaumēm un budžetiem — iegādei vai nomai.",
    checkAvailability: "Noskaidrot pieejamību",
    serviceAlterTitle: "Pielāgošana un šūšana",
    serviceAlterText: "Pārrunājam nepieciešamās izmaiņas un pielāgošanu, lai kleita derētu tieši tev.",
    serviceAccessoriesTitle: "Līgavas aksesuāri",
    serviceAccessoriesText: "Plīvuri un tēla detaļas, ko vari piemeklēt kopā ar kleitu vienā vizītē.",
    serviceGroomTitle: "Līgavaiņa tēls",
    serviceGroomText: "Jautā par vīriešu uzvalku nomu un aktuālajām iespējām salonā.",
  ...
  ru: {
    ...
    heroLead: "Продажа и прокат свадебных платьев, аксессуары и индивидуальный подбор — на спокойной, личной примерке в центре Елгавы.",
    ...
    servicesKicker: "Всё в одном месте",
    servicesTitle: "Не только выбрать.<br><em>Но и подготовить до конца.</em>",
    servicesLead: "От первой примерки до платья, готового к твоему дню. Наличие конкретной модели, размера или услуги быстрее всего уточнить в WhatsApp.",
    servicePrimaryLabel: "Главное",
    serviceDressTitle: "Свадебные платья",
    serviceDressText: "Модели для разных силуэтов, вкусов и бюджета — для покупки или проката.",
    checkAvailability: "Уточнить наличие",
    serviceAlterTitle: "Подгонка и пошив",
    serviceAlterText: "Обсудим необходимые изменения и посадку, чтобы платье подходило именно тебе.",
    serviceAccessoriesTitle: "Аксессуары невесты",
    serviceAccessoriesText: "Фаты и детали образа, которые можно подобрать вместе с платьем за один визит.",
    serviceGroomTitle: "Образ жениха",
    serviceGroomText: "Уточни актуальные возможности аренды мужских костюмов в салоне.",
  ...
  en: {
    ...
    heroLead: "Wedding dresses for sale and hire, accessories and personal curation — in one calm, private fitting in central Jelgava.",
    ...
    servicesKicker: "Everything in one place",
    servicesTitle: "Not only chosen.<br><em>Prepared for the day.</em>",
    servicesLead: "From your first fitting to a dress ready for your wedding. Ask us on WhatsApp about a specific model, size or service.",
    servicePrimaryLabel: "The essential",
    serviceDressTitle: "Wedding dresses",
    serviceDressText: "Styles for different silhouettes, tastes and budgets — available to buy or hire.",
    checkAvailability: "Check availability",
    serviceAlterTitle: "Alterations and sewing",
    serviceAlterText: "We discuss the adjustments and fit needed to make the dress work for you.",
    serviceAccessoriesTitle: "Bridal accessories",
    serviceAccessoriesText: "Veils and finishing details to pair with your dress during the same visit.",
    serviceGroomTitle: "The groom’s look",
    serviceGroomText: "Ask about current men’s suit hire options available through the salon.",
