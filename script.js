const copy = {
  lv: {
    ...
    heroLead: "Salonā vari pielaikot gatavus modeļus, pasūtīt kleitu pēc saviem mēriem vai atnest fotogrāfiju ar ieceri. Palīdzēsim ar izvēli, pielāgošanu un pēdējām detaļām.",
    ...
    s5Text: "Pieņemam kleitas tīrīšanai pirms kāzām vai pēc svinībām. Par iespējamo rezultātu un termiņu vienojamies pēc kleitas apskates.",
  ...
  ru: {
    ...
    heroLead: "В салоне можно примерить готовые модели, заказать платье по своим меркам или принести фотографию с идеей. Поможем с выбором, подгонкой и последними деталями.",
    ...
    s5Text: "Принимаем платья на чистку до свадьбы или после торжества. Возможный результат и срок обсуждаем после осмотра.",
  ...
  en: {
    ...
    heroLead: "Try ready-made gowns, order a dress made to your measurements or bring a photograph of your idea. We can help with the choice, alterations and finishing details.",
    ...
    s5Text: "We accept dresses for cleaning before the wedding or after the celebration. The expected result and timing are discussed after inspection.",
